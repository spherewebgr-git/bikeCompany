...
<head>
    ...
    <title>Welcome to Bike Company</title>
</head>
                ...
                <tr>
                    <td style="padding:35px 30px; color:#374151; font-size:15px; line-height:1.6;">
                        ...
                        <p style="margin:0 0 20px;">
                            Welcome to Bike Company. Your account has been created
                            successfully and you can now explore our bikes for
                            purchase or rental.
                        </p>
                        ...
                        <div style="margin:25px 0; padding:20px; background-color:#ecfdf5; border:1px solid #a7f3d0; border-radius:6px;">
                            ...
                            <p style="margin:8px 0 0; color:#047857;">
                                You can now sign in, manage your profile, save your
                                payment cards and view your current and previous orders.
                            </p>
                        ...
                        <p style="margin:30px 0 0;">
                            Thank you for joining Bike Company.
                        </p>

                        <p style="margin:5px 0 0; color:#6b7280; font-size:14px;">
                            We hope you find the perfect bike for your next journey.
                        </p>
